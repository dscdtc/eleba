  ...
  .shopcart
    ...
    .content
      ...
      .content-left
        flex 1
        .logo-wrapper
          display inline-block // 存在间隙问题设置父级font-size
          vertical-align top
          position relative
          top -10px
          margin 0 12px
          padding 6px
          width 56px // 盒模型padding+content+border
          height 56px
          box-sizing border-box
          border-radius 50% // display circle
          background #141d27
          .logo
            width 100%
            height 100%
    ...
    .ball-container
      .ball
        ...
        bottom: 22px
        z-index: 200
        transition: all .4s cubic-bezier(0.49, -0.29, 0.75, 0.41) // 抛物线
        .inner
          width: 16px
          height: 16px
          border-radius: 50%
